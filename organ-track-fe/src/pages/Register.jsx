          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-3 rounded-xl outline-none text-xs sm:text-sm md:text-base"
                />
              </div>
              {errors.username && (
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full bg-white pl-10 sm:pl-12 pr-10 py-2.5 sm:py-3 rounded-xl outline-none text-xs sm:text-sm md:text-base"
              />
              <i
            ...
            <div>
              <div className="relative">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-white pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 rounded-xl outline-none appearance-none text-xs sm:text-sm md:text-base"
                >
