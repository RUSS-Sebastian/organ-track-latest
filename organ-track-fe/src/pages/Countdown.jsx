              ...
              {!canAnswer ? (
                <div className="space-y-3">
                  <p className="text-sm text-gray-400">
                    {testMode
                      ? "⏱️ Test countdown in progress"
                      : "Time remaining until next check-in"}
                  </p>
                  <div className="bg-green-50/50 backdrop-blur-sm rounded-xl p-4">
                    <p className="text-sm text-green-700">
                      ⏳ Please wait {timeLeft.hours}h {timeLeft.minutes}m{" "}
                      {timeLeft.seconds}s to enter the next Check-in
                      {testMode && (
                ...
                >
                  <div className="bg-green-50/50 backdrop-blur-sm rounded-xl p-4 hover:bg-green-100/50 hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-green-300">
                    ...
                    {testMode && (
                      <span className="block text-xs text-purple-600 mt-1"></span>
                    )}
                  </div>
                </div>
              )}
