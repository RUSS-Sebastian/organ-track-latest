...
const EditProfile = () => {
  ...
  const handleSaveClick = () => {
    ...
    if (isPasswordChanged && tempPassword !== MASKED_PASSWORD && tempPassword.trim() !== '') {
      ...
      <div className="edit-profile-container">
        ...
        <div className="profile-content">
            ...
            <div className="profile-image-wrapper">
              ...
              {isEditing && (
                <>
                  ...
                  />
                  <label htmlFor="profile-image-input" className="change-photo-link">
                    Change Photo
                  </label>
                </>
              )}
          ...
          <div className="profile-table">
            ...
            <div className="table-row">
              ...
              <div className="row-value">
                {isEditing ? (
                  ...
                  <span className="display-value">{userData.name}</span>
                )}
              </div>
            </div>
            ...
            <div className="table-row">
              ...
              <div className="row-value">
                {isEditing ? (
                  ...
                  <span className="display-value password-dots">
                    {MASKED_PASSWORD}
                  </span>
                )}
              </div>
            ...
            {/* DOB */}
            <div className="table-row">
              <div className="row-label">Date of Birth</div>
              <div className="row-value">
                {isEditing ? (
                  <input
                    type="date"
            ...
            <div className="table-row">
              ...
              <div className="row-value">
                {isEditing ? (
                  ...
                  <span className="display-value">{userData.gender}</span>
                )}
              </div>
            </div>
          </div>
      ...
      {showConfirmModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p className="modal-subtitle">Please re-enter your password to confirm</p>
