...
const translations = {
  ...
  mm: {
    statsTitle: "ကျန်းမာရေး အလေးထားသူများ ယုံကြည်စိတ်ချစွာ အသုံးပြုလျက်ရှိသည်။",
    stats: [
      { value: "99", suffix: "%", label: "အသုံးပြုသူများ လွယ်ကူရိုးရှင်းမှု" },
      { value: "90", suffix: "%", label: "ယုံကြည်စိတ်ချရမှု" },
      { value: "95", suffix: "%", label: "အသုံးပြုသူ စိတ်ကျေနပ်မှု" },
      { value: "24", suffix: "/၇", label: "အဆက်မပြတ် စောင့်ကြည့်စစ်ဆေးမှု" },
    ],
    testimonialsTitle: "သုံးစွဲသူများ၏ အမြင်",
    testimonialsSubtitle:
      "ကိုယ်အင်္ဂါကျန်းမာရေးကို စနစ်တကျ စောင့်ကြည့်သူများ၏ ကိုယ်တွေ့စကားသံများ",
    testimonials: [
      {
        quote:
          "OrganTrack က ကျွန်မရဲ့ အသည်းမှာ ဝန်ပိနေတဲ့ အစောပိုင်းလက္ခဏာတွေကို သိရှိအောင် ကူညီပေးခဲ့ပါတယ်။ ကျွန်မရဲ့ဆရာဝန်ကလည်း အသေးစိတ်ကျတဲ့ အစီရင်ခံစာတွေကို ကြည့်ပြီး သဘောကျသွားပါတယ်။",
        author: "ဖြူစင်သန့်",
      ...
      {
        quote:
          "နေ့တိုင်း ကိုယ်အင်္ဂါကျန်းမာရေးကို စစ်ဆေးဖြစ်တာကြောင့် ကိုယ့်ကိုယ်ကိုယ် ပိုပြီးဂရုစိုက်မိလာတယ်။ ပေးတဲ့အကြံပြုချက်တွေကလည်း တကယ့်ကို လက်တွေ့ကျပြီး အသုံးဝင်တယ်ဗျ။",
        author: "သုတကျော်",
        role: "ကျန်းမာရေးအလေးထားသူ",
        rating: 5,
      },
      {
        quote:
          "မိသားစုထဲမှာ နှလုံးရောဂါမျိုးရိုးရှိတဲ့သူတစ်ယောက်အနေနဲ့ ဒီ app လေးက တကယ့်ကို စိတ်အေးသွားစေပါတယ်။ အားလုံးပဲ သုံးကြည့်ဖို့ အထူးအကြံပြုချင်ပါတယ်!",
        author: "ဒေးဗစ်အောင်",
        role: "ကျန်းမာရေးကို ကြိုတင်စောင့်ကြည့်သူ",
        rating: 5,
      },
      {
        quote:
          "ကိုယ်အင်္ဂါအမျိုးမျိုးကို တစ်ပြိုင်တည်း လွယ်လွယ်ကူကူ ခြေရာခံနိုင်တာကို အရမ်းသဘောကျပါတယ်။ အစီရင်ခံစာတွေက ရှင်းလင်းပြီး ကျွန်မရဲ့ဆရာဝန်ကလည်း တကယ့်ကို ကြိုက်ပါတယ်။",
        author: "Sarah Chen",
        role: "အသုံးပြုသူ (၃ လ)",
        rating: 5,
      },
      {
        quote:
          "ရေသောက်တာနဲ့ အိပ်စက်မှုမှတ်တမ်းတွေကြောင့် ကျွန်တော့်ရဲ့ ကျောက်ကပ်ကျန်းမာရေး သိသိသာသာ ကောင်းလာပါတယ်။",
        author: "Michael Rodriguez",
        role: "အားကစားဝါသနာရှင်",
        rating: 5,
      },
      {
        quote:
          "ခွဲစိတ်မှုအပြီးမှာ OrganTrack ကြောင့် ကျွန်မရဲ့အသည်း အခြေအနေ ပြန်ကောင်းလာတာကို စိတ်ချလက်ချ သိရှိနိုင်ခဲ့ပါတယ်။",
        author: "Emma Thompson",
        role: "ခွဲစိတ်မှုအပြီး ပြန်လည်နာလန်ထူလာသူ",
        rating: 4,
      },
      {
        quote:
          "သတိပေးချက်တွေကြောင့် ပုံမှန်လေး လုပ်ဖြစ်သွားပါတယ်။ အရင်ကထက်လည်း ကိုယ့်ခန္ဓာကိုယ်အခြေအနေကို ပိုပြီး သိရှိနားလည်လာရပါတယ်။",
        author: "James Wilson",
        role: "အလုပ်များသော ပညာရှင်",
        rating: 5,
      },
      {
        quote:
          "ခိုင်လုံတဲ့ အထောက်အထားအခြေပြု အကြံပြုချက်တွေကို သဘောကျပါတယ်။ ကျန်းမာရေးနည်းပြတစ်ယောက် ဘေးနားမှာ ရှိနေသလိုမျိုး ခံစားရပါတယ်။",
        author: "Linda Park",
        role: "ကျန်းမာရေးလမ်းညွှန်သူ",
        rating: 5,
      },
      {
        quote:
          "ကိုယ်အင်္ဂါကျန်းမာရေး အမှတ်ပြဇယားတွေကတော့ တကယ့်ကို ထူးခြားပါတယ်။ လအလိုက် တိုးတက်မှုတွေကို ရှင်းရှင်းလင်းလင်း မြင်နိုင်လို့ အရမ်းမိုက်တယ်။",
        author: "Robert Kim",
      ...
      {
        quote:
          "သက်ကြီးပိုင်းတစ်ယောက်အနေနဲ့ ခဏခဏ ဆေးခန်းမသွားရဘဲ နှလုံးနဲ့ အဆုတ်ကို စောင့်ကြည့်နိုင်အောင် ဒီ app လေးက ကူညီပေးပါတယ်။",
        author: "Margaret Lee",
        role: "အငြိမ်းစားနာပြုဆရာမ",
        rating: 5,
      },
      {
        quote:
          "UI က သန့်ရှင်းပြီး အသုံးပြုရတာ အရမ်းလွယ်ပါတယ်။ တစ်မိသားစုလုံး သုံးဖို့တောင် ကျွန်တော် တိုက်တွန်းထားပါတယ်။",
        author: "Daniel Garcia",
      ...
      {
        quote:
          "ကိုယ်အင်္ဂါကျန်းမာရေးနဲ့အတူ စိတ်ဖိစီးမှုကိုပါ တွဲပြီးခြေရာခံလိုက်တော့ အရင်က မသိခဲ့တဲ့ အချက်အလက်သစ်တွေကို သိရှိခွင့်ရခဲ့ပါတယ်။",
        author: "Olivia Martinez",
        role: "စိတ်ကျန်းမာရေးအတိုင်ပင်ခံ",
        rating: 5,
      },
      {
        quote:
          "စသုံးခါစက သိပ်မယုံခဲ့ပေမယ့် အန္တရာယ်ရှိနိုင်ခြေ သတိပေးချက်တွေရဲ့ တိကျမှုကိုတော့ တကယ့်ကို အထင်ကြီးမိပါတယ်။",
        author: "Christopher White",
        role: "ဒေတာခွဲခြမ်းစိတ်ဖြာသူ",
        rating: 5,
      },
      {
        quote:
          "OrganTrack ကြောင့် ရေပိုသောက်ဖြစ်ပြီး ပိုပြီးနှစ်ခြိုက်စွာ အိပ်ပျော်လာပါတယ်။ ကျွန်မရဲ့ အသားအရေနဲ့ ကျောက်ကပ်က ကျေးဇူးတင်နေမှာ အသေအချာပါပဲ!",
        author: "Sophia Brown",
        role: "အလှအပနှင့် ကျန်းမာရေး Blogger",
        rating: 5,
      },
      {
        quote:
          "PDF အစီရင်ခံစာတွေက ကျန်းမာရေးစောင့်ရှောက်မှုအဖွဲ့နဲ့ တိုင်ပင်ဆွေးနွေးဖို့အတွက် တကယ့်ကို အဆင်ပြေပါတယ်။",
        author: "Andrew Taylor",
        role: "နာတာရှည်ရောဂါကို ဂရုစိုက်နေသူ",
        rating: 5,
      },
    ],
    badges: {
      hipaa: "HIPAA စံနှုန်းနှင့်အညီဖြစ်ခြင်း",
      encryption: "အစမှအဆုံး လုံခြုံရေးစနစ် (End-to-End Encryption)",
      medicalBoard: "ဆေးဘက်ဆိုင်ရာ အကြံပေးအဖွဲ့",
    },
  },
};
